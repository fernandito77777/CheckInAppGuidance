...
Sekarang, kita akan membuat *access key* dan *secret access key* untuk akses ke AWS CLI. Perlu diingat bahwa akun anda harus memiliki akses `Cognito`, `Lambda`, dan `Api Gateway`
